...
<section class="py-5 border-bottom">
  <div class="container">
    <div class="row d-flex flex-column align-content-center justify-content-center mx-auto">
      <div class="col-12 mx-auto d-flex flex-column text-center">
        <h3>No products added to the wishlist</h3>
        <div>
          <a href="index.blade.php" class="btn btn-info text-white rounded-3">Back To Home</a>
        </div>
      </div>
      </div>
    </div>
