    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            ...
            <div class="d-block d-lg-none">
                ...
                <a href="{{route('Client.getCart')}}" class="header__icon text-decoration-none mx-2 text-white header__icon--account link focus-inset position-relative">
            ...
            <div class="collapse navbar-collapse justify-content-end">
                ...
                <ul class="navbar-nav ms-5 mb-2 mb-lg-0 align-items-center d-flex">
                    ...
                    <div>
                        ...
                        <a href="#" class="search" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
