                    ...
                    <div class="row bg-white mt-3 d-flex justify-content-center mx-auto">
                      ...
                      <div class="d-flex justify-content-between mt-3 align-items-center">
                        ...
                        <div class="d-flex flex-column justify-content-end align-items-end">
                          ...
                          <div class="form-check" style="padding:0 0 7px 0;; display: {{shippingType()=='1'? 'block':'none'}}">
                          ...
                          <div class="form-check" style="padding:0 0 7px 0;; display: {{shippingType()=='3'? 'block':'none'}}">
                            <input class="" type="radio" id="flexRadioDefault1" checked>
                            <label class="form-check-label fs-7 text-secondary" for="flexRadioDefault1" style="color:black !important;">
                      ...
                      <div class="d-flex justify-content-between mt-3">
                        ...
                        <h6 class="text-black fw-semibold">
                        <span>
                        {{ format_number($subTotalCart + $vat + (shippingType() == '1' ? setting('internal_shipping_cost')*Country()->currancy_value : (shippingType() == '3' ? setting('international_shipping_cost')*Country()->currancy_value : 0))) }}
                        </span>
                          <span>
                            {{Country()->currancy_code}}
                        </span>
                      ...
                      <div class="mt-3 {{lang()=='ar'? 'text-end' : 'text-start'}}">
                        ...
                        {{--                          <div class="d-flex justify-content-between align-items-center">--}}
                        {{--                              <h6 class="form-check fs-7 d-flex p-0">--}}
                        {{--                                  <input class="--}}{{--form-check-input--}}{{--" type="radio" name="payment_id" value="3" id="flexRadioDefault2" >--}}
                        {{--                                  <label class="form-check-label mt-1 mx-1" for="flexRadioDefault2">--}}
                        {{--                                      @lang('trans.credit_Card')--}}
                        {{--                                  </label>--}}
                        {{--                              </h6>--}}
                        {{--                              <img src="{{asset('assets_client/images/ccavenue_pay_options.gif')}}" alt="" class="mb-2" width="250">--}}
                        {{--                          </div>--}}
                      </div>
                      <div class="border-bottom"></div>
