...
<section class="py-5 border-bottom">
  <div class="container">
    <div class="row d-flex align-items-center">
      <div class="col-6">
        <h1 class="text-info fw-semibold fs-200">404</h1>
        <h3 class="text-danger fw-semibold">Oops ! Sorry We Can't Find That Page.
        </h3>
          <h6 class="lh-lg text-secondary">Can't find what you looking for? Take a moment and do a search below or start from our 
      ...
      <div class="col-6">
        <img src="images/error-404-image.png" alt="">
      </div>
      </div>
    </div>
  </div>
