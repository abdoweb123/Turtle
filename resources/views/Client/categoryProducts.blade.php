            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        <h4 class="fw-semibold d-none d-md-flex"> {{strtoupper($category['title_'.lang()])}}</h4>
                        <div>
                            ...
                            <span class="mx-1">/</span>
                            <span class="mx-1"> {{strtoupper($category['title_'.lang()])}}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                                    ...
                                    <div class="border-bottom"  style="max-height: 300px; overflow-y: auto;">
                                        ...
                                        @forelse($category->children as $subCategory)
                                            <div class="form-check d-flex">
                                                ...
                                                <label class="form-check-label text-secondary fs-7 mt-1 {{lang()=='en'?'mx-2':'mx-5'}}" for="flexCheckDefault">
                                ...
                                <div class="mt-4">
                                    ...
                                    @foreach($highestViewedProducts as $product)
                                        <a class="d-flex align-items-center text-decoration-none mb-3" href="{{route('Client.productDetails',$product->id)}}">
                                            <div>
                                                <img src="{{asset($product->Gallery()->whereNull('color_id')->first()->image ?? Setting('not_found_img'))}}" alt="" width="70">
                                            </div>
                                            <div class="mx-3">
                ...
                <div class="col-md-3 d-none d-lg-block">
                    <form id="categoryProductsForm2" action="{{route('Client.categoryProducts',['category'=>$category->id,'search'=>'search'])}}" method="post">
                        @csrf
                        <button type="submit" class="btn btn-info rounded-0 main-btn btn-hover text-center mb-2 px-3 py-1">@lang('trans.search')</button>
                        <a href="{{route('Client.categoryProducts',$category->id)}}" class="btn btn-info rounded-0 main-btn btn-hover text-center mb-2 px-3 py-1" style="background-color: #24262733 !important; border-color: #9bbfd133 !important;">
                            <i class="vc_icon_element-icon fa fa-refresh px-1"></i>
                            @lang('trans.clear')
                        </a>
                ...
                <div class="col-lg-9">
                    <!-- start header  -->
                    <div class="d-flex justify-content-between">
                        <p class="mt-2 text-seconday d-none d-md-flex"> @lang('trans.all_results') {{count($allProducts)}}</p>
                        <div class="d-flex">
                                                    ...
                                                    <div class="row" style="justify-content: space-around;">
                                                        ...
                                                        @forelse($product->Gallery()->whereNotNull('color_id')->groupBy('color_id')->get() as $gallery)
                                                            ...
                                                            <div class="col-sm-2 col-3">
                                                                <div class="m-0 p-0">
                                                                    <img src="{{$gallery->image}}" class="border rounded-1 border-img tooltip-img imageTooltip" width="40" alt="">
                                                                </div>
                                                            </div>
                                                        @empty
                                                        <!-- No galleries found -->
                                                    ...
                                                    <div class="row" style="justify-content: space-around;">
                                                        @forelse($product->Gallery()->whereNotNull('color_id')->groupBy('color_id')->get() as $gallery)
                                                            <div class="col-sm-3 col-3">
                                                                <div class="m-0 p-0">
                                                                    <img src="{{$gallery->image}}" class="border rounded-1 border-img tooltip-img imageTooltip" width="30" alt="">
                                                                </div>
                                                            </div>
                                                        @empty
                                                        <!-- No galleries found -->
