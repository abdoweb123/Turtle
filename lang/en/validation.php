...
return [
    ...
    'attributes' => [
        ...
        'first_name_billing'=>'Billing first name',
        'last_name_billing'=>'Billing last name',
        'country_id_billing'=>'Billing country',
        'address1_billing'=>'Billing House number and street name',
        'city_billing'=>'Billing city',
        'phone_billing'=>'Billing phone',
        'email_address'=>'Billing email address',
        'first_name_shipping'=>'Shipping first name',
        'last_name_shipping'=>'Shipping last name',
        'city_shipping'=>'Shipping city',
        'address1_shipping'=>'Shipping House number and street name',
        'terms_conditions'=>'Please read and accept the terms and conditions to proceed with your order.',
    ],
