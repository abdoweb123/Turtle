...
@section('content')
<form method="POST" action="{{ route('admin.country.regions.update', ['country'=>$Country,'region'=>$Region,]) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="number" step="0.01" min="0" name="delivery_cost" id="delivery_cost" class="form-control" required value="{{ $Region['delivery_cost'] }}">
        </div>
