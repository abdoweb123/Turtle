...
@section('content')
<form method="POST" action="{{ route('admin.colors.update',$Model) }}" enctype="multipart/form-data" >
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <label for="hexa">@lang('trans.hexa')</label>
            <input id="hexa" type="color" name="hexa" required placeholder="@lang('trans.hexa')" class="form-control" value="{{ $Model['hexa'] }}">
        </div>
        <div class="col-12">
