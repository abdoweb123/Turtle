...
<form action="{{ route('admin.admins.update',$Model) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" type="tel" name="phone" id="phone_number" placeholder="{{ __('trans.Phone Number') }}" value="{{ old('phone',$Model->phone) }}" required autocomplete="phone">
        </div>
        <div class="col-md-6">
